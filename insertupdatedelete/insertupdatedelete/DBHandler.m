...
-(void)checkDBAndCopy
{
    ...
    strDBPath=[connectionPath stringByAppendingPathComponent:@"testdb.sqlite"];
        ...
        if (sqlite3_prepare_v2(contactDB, [strQuery UTF8String], -1, &complieStmt, NULL)==SQLITE_OK) {
            ...
            while (sqlite3_step(complieStmt)==SQLITE_ROW) {
                ...
                //[dict setValue:[NSString stringWithFormat:@"%d",sqlite3_column_int(complieStmt, 1)] forKey:@"cid"];
                 [dict setObject:[NSString stringWithUTF8String:(char *)sqlite3_column_text(complieStmt, 1)] forKey:@"firstname"];
                [dict setObject:[NSString stringWithUTF8String:(char *)sqlite3_column_text(complieStmt, 2)] forKey:@"lastname"];
                
                
                [dict setObject:[NSString stringWithUTF8String:(char *)sqlite3_column_text(complieStmt, 3)] forKey:@"mobileno"];
